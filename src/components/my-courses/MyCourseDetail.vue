...
export default {
  ...
  methods: {
    ...
    async openLessonModal(lesson) {
      console.log('openLessonModal викликано з уроком:', lesson);
      this.lessonLoading = true;
      try {
        console.log('Запитую повні дані уроку з ID:', lesson.id);
        ...
        console.log('Оброблені дані уроку:', lessonData);
        this.selectedLesson = { ...lesson, ...lessonData };
        this.showLessonModal = true;
        console.log('Модаль відкрито з уроком:', this.selectedLesson);
      } catch (e) {
        console.error('Помилка при отриманні уроку:', e);
        this.selectedLesson = lesson;
        this.showLessonModal = true;
        console.log('Модаль відкрито з базовим уроком:', this.selectedLesson);
      } finally {
