<template>
  <div class="pending-reviews-tab">
    <!-- Заголовок та дії -->
    <div class="tab-header">
      <div class="header-info">
        <h2 class="tab-title">Відгуки на модерації</h2>
        <p class="tab-subtitle">Перегляньте та схваліть відгуки користувачів</p>
      </div>
    ...
    <div class="reviews-list">
      ...
      <div v-else-if="reviews.length === 0" class="empty-state">
        ...
        <h3>Немає відгуків для модерації</h3>
        <p>Всі відгуки вже оброблені</p>
      </div>
    ...
    <div v-if="selectedReview" class="modal-overlay" @click="closeModal">
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-footer">
          <button @click="approveReview(selectedReview.id)" class="action-button approve">
            <v-icon>mdi-check</v-icon>
            Схвалити
          </button>
          <button @click="rejectReview(selectedReview.id)" class="action-button reject">
            <v-icon>mdi-close</v-icon>
            Відхилити
          </button>
