<template>
  <div class="pending-comments-tab">
    <!-- Заголовок та дії -->
    <div class="tab-header">
      <div class="header-info">
        <h2 class="tab-title">Коментарі на модерації</h2>
        <p class="tab-subtitle">Перегляньте та схваліть коментарі користувачів</p>
      </div>
    ...
    <div class="comments-list">
      ...
      <div v-else-if="comments.length === 0" class="empty-state">
        ...
        <h3>Немає коментарів для модерації</h3>
        <p>Всі коментарі вже оброблені</p>
      </div>
        ...
        >
          ...
          <div class="comment-header">
            ...
            <div class="comment-status">
              <span class="status-badge pending">На модерації</span>
            </div>
          </div>
    ...
    <div v-if="selectedComment" class="modal-overlay" @click="closeModal">
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-footer">
          <button @click="approveComment(selectedComment.id)" class="action-button approve">
            <v-icon>mdi-check</v-icon>
            Схвалити
          </button>
          <button @click="rejectComment(selectedComment.id)" class="action-button reject">
            <v-icon>mdi-close</v-icon>
            Відхилити
          </button>
